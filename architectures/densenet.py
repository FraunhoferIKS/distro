...
#     num_classes = 10 if dataset=='CIFAR10' else 100
    ...
    bottleneck = True
    droprate = 0.0
    normalizer = torchvision.transforms.Normalize(mean=[x/255.0 for x in [125.3, 123.0, 113.9]],
                                                std=[x/255.0 for x in [63.0, 62.1, 66.7]])

    model = DenseNet3(layers, num_classes, growth, reduction=reduce,
                         bottleneck=bottleneck, dropRate=droprate, normalizer=None)
